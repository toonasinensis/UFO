...
# =============================================================================
# Promoted overnight best: edit this explicit block to resume/finalize another run.
# =============================================================================
PYTHON_BIN=".venv/bin/python"
OUTPUT_DIR="experiments/bfm_trajectory_latent_adaptation/outputs/overnight_link_tuning_20260813/promoted_best_weight090"
...
echo "Promoted run finalized at completed step ${completed_steps}"
